...
[
  {
    ...
    "subParams": [
        ...
        "radioItems": [
          {
            ...
            "subParams": [],
            "help": "Fire this event when the customer reaches your landing page in order to store the \u003cb\u003e click ID \u003c/b\u003e from your ad destination URL on the cookie \u003cb\u003e_exoclick_cid\u003c/b\u003e. This cookie value can be later used to populate the conversion event."
          },
          {
            "value": "conversion",
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "Enter your custom Click ID URL Parameter Name. It is the URL Parameter for your \u003cb\u003e{conversions_tracking} \u003c/b\u003e token found in your ad destination URL. It is user-defined in the ExoClick platform at Ad Level. \n\u003c/br\u003e\n\u003c/br\u003e\nIn this following example, \u003cb\u003eexotracker\u003c/b\u003e would be the correct value to fill this input.\n\u003c/br\u003e\n\u003c/br\u003e\n\u003ci\u003e(e.g. http://www.yoursite.com/?\u003cb\u003eexotracker\u003c/b\u003e\u003d{conversions_tracking}\u003c/i\u003e",
        "valueValidators": [
          {
            "type": "NON_EMPTY"
          }
  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "\u003cb\u003eRequired\u003c/b\u003e.\n\u003cbr/\u003e\u003cbr/\u003e\nIf left empty, this value will be automatically taken from the \u003cb\u003e_exoclick_cid\u003c/b\u003e cookie, which is set on pages containing the \u003cb\u003e{conversions_tracking}\u003c/b\u003e ad destination token in the Click ID Key URL parameter.\n\u003cbr/\u003e\nIf you do not wish to fallback to the default value, pass your own value to this field.\n\u003cbr/\u003e\nOnly modify it if you have a custom implementation.\n\u003c/br\u003e\nCheck \u003ca href\u003d\"https://docs.exoclick.com/docs/conversion-tracking/\"\u003e documentation \u003c/a\u003e for more information."
      },
      {
        "type": "TEXT",
        "name": "conversionValue",
        "displayName": "Conversion Value (for dynamic values)",
        "simpleValueType": true,
        "help": "\u003cb\u003eRequired\u003c/b\u003e in case you are using dynamic values on this Conversion Goal.\n\u003cbr/\u003e\nIf your Conversion Goal has a fixed value or no value, you can leave this field empty."
      },
      {
        "type": "CHECKBOX",
        "name": "cookieSync",
        ...
        "simpleValueType": true,
        "help": "Check this box if you want to send 3rd party cookie-syncing pixels from the browser if the server-side conversion request fails due to no available Click ID to be used or due to an invalid Click ID.",
        "defaultValue": true,
        "enablingConditions": [
          {
...
Created on 11/12/2025, 14:22:45
