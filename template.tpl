  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "The conversion value, in case you are using dynamic values on this conversion. If your conversion has a fixed value you can leave this field empty.",
        "valueValidators": [
          {
            "type": "NON_EMPTY"
          }
